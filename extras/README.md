...
+ How-to add a new template to an existing category
	+ clean-up template file as indicated on wiki <https://wiki.lofice.io/Documentation/HowTo/Impress/Make_template_language_independent>
	+ recommendation for settings.xml are given on wiki <https://wiki.lofice.io/Documentation/CompatibilityFlags#Settings_to_include_in_a_new_template>
