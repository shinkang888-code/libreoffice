# lofice Licensing Blurb

Contains the stock lofice licensing blurb, as distributed in the install
...
externals may or may not be shipped with lofice. Therefore, we need to pass
