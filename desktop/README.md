...
Code for the lofice main binary (`soffice`) resides here. The `soffice_main`
function for the `soffice` binary can be found here.


## Stable Interface

Some of the artifacts built here are part of a lofice installation set's
...
### oosplash
Splash screen for the lofice `soffice` binary.
...
* `test/deployment/crashextension`: C++ extension to make lofice crash. Useful for testing Crashreporter.
