...
to strings in content broker world, or connect lofice with
...
https://wiki.lofice.io/Documentation/DevGuide/Universal_Content_Providers#The_WebDAV_Content_Provider
...
implementation (since lofice 7.3), but in case of behavioural
...
* The upper layer implements the UNO API which is called by lofice, and
