...
$(eval $(call gb_CppunitTest_CppunitTest,loficekit_checkapi))

$(eval $(call gb_CppunitTest_add_cxxflags,loficekit_checkapi, \
    $(gb_CXX03FLAGS) \
))
...
ifeq ($(OS),LINUX)
$(eval $(call gb_CppunitTest_add_libs,loficekit_checkapi, \
    -ldl \
))
endif
