...
- `lofice`: draft ODF schema, with additional LO extensions

The extension schema in `lofice/` is used by all unit tests if
...
[1] `git grep TODO schema/lofice`

[2] <https://wiki.lofice.io/Development/ODF_Implementer_Notes/List_of_lofice_ODF_Extensions>
