...
To get started, first start lofice listening on port 2083
...
Windows. In this way, the lofice internal Python interpreter will be used.
...
This command searches lofice documents recursively under directory
