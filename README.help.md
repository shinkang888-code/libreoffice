...
lofice can build three kinds of help output from helpcontent2:

* XML (local, bundled with lofice < 6.0)
* HTML (local, bundled with lofice >= 6.0)
* HTML (online)
...
This type was bundled per-default until lofice 6.0.
...
help inside bundled extensions, but both are not part of the lofice SDK.

## HTML help, bundled

This type is bundled per-default since lofice 6.0 and displayed in a
browser.

## HTML help, online

This help is the external one, currently provided by help.lofice.org. It
